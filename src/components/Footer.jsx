...
const Footer = () => (
    <footer className={styles.footer}>
        <div className={styles.top}>
            <div><strong>React Firebase Auth</strong><p>Authentication flow with protected routes.</p></div>
            <div className={styles.groups}><div><span>Connect</span><Links items={links} /></div><div><span>Support</span><Links items={support} /></div></div>
        </div>
        <div className={styles.bottom}>
            ...
            <span>Firebase authentication example</span>
        </div>
    </footer>
);
